...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <div class="mb-8 flex justify-between items-center">
        <div>
            ...
            <p class="mt-2 text-gray-600 dark:text-gray-400">Control which doctors can access your health profile information</p>
        </div>
        ...
        <div class="flex items-start">
            ...
            <div>
                ...
                <p class="text-sm text-blue-700 dark:text-blue-300 mt-1">
                    You control who can view your health profile. Only doctors you've had appointments with can be granted access. 
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div class="bg-white dark:bg-gray-800 shadow-xl rounded-2xl border dark:border-gray-700 overflow-hidden">
            ...
            <div class="p-6">                @forelse($permissions->where('is_granted', true) as $permission)
                    <div class="border border-gray-200 dark:border-gray-600 rounded-lg p-4 mb-4 last:mb-0">
                        <div class="flex justify-between items-start">
                            ...
                            <div class="ml-4 flex flex-col space-y-2">
                                <button onclick="showRevokeModal({{ $permission->id }}, '{{ $permission->doctor->name }}')"
                ...
                @empty
                    <div class="text-center py-8">
                        ...
                        <p class="text-gray-600 dark:text-gray-400">No doctors have been granted access to your health profile yet.</p>
                    </div>
                @endforelse
            </div>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 shadow-xl rounded-2xl border dark:border-gray-700 overflow-hidden">
            ...
            <div class="p-6">
                @if($doctorsWithoutPermission->count() > 0)
                    <form action="{{ route('patient.health-profile.permissions.grant') }}" method="POST" class="space-y-4">
                        @csrf
                ...
                @else
                    <div class="text-center py-8">
                        ...
                        <p class="text-sm text-gray-500 dark:text-gray-400">
                            You can only grant access to doctors who have had appointments with you and don't already have access.
                        </p>
                    </div>
                @endif
            </div>
    ...
    @if($permissions->where('is_granted', false)->count() > 0)
        <div class="mt-8 bg-white dark:bg-gray-800 shadow-xl rounded-2xl border dark:border-gray-700 overflow-hidden">
            ...
            <div class="p-6">
                <div class="space-y-4">                    @foreach($permissions->where('is_granted', false) as $permission)
                        <div class="border border-gray-200 dark:border-gray-600 rounded-lg p-4 bg-gray-50 dark:bg-gray-700/50">
                            <div class="flex justify-between items-start">
                                ...
                                <div class="ml-4">
                                    <form action="{{ route('patient.health-profile.permissions.grant') }}" method="POST" class="inline">
                                        @csrf
