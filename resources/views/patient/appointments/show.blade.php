        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
            <div class="mb-4 sm:mb-0">
                <div class="flex items-center space-x-4">
                    <div class="bg-gradient-to-r from-blue-600 to-blue-700 w-12 h-12 rounded-lg flex items-center justify-center">
                        ...
                        <div class="space-y-4">
                            <div class="bg-gradient-to-r from-blue-50 to-blue-100 dark:from-blue-900/20 dark:to-blue-800/20 p-4 rounded-lg border border-blue-200 dark:border-blue-700">
                                ...
                                <p class="text-sm text-blue-600 dark:text-blue-400 mt-1">
                                    Duration: {{ $appointment->duration_minutes ?? $appointment->service->duration_minutes ?? 30 }} minutes
                                </p>
                            </div>
                        </div>
                            ...
                            <div class="bg-gray-50 dark:bg-gray-700/50 p-4 rounded-lg">
                                ...
                                <div class="mt-2">
                                    <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium
                                        {{ $appointment->priority === 'high' || $appointment->priority === 'urgent' ? 'bg-red-100 text-red-800 dark:bg-red-900/20 dark:text-red-400' :
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700">
                <div class="p-6">
                    ...
                    <div class="flex items-start space-x-4">
                        <div class="bg-gradient-to-br from-green-100 to-green-200 dark:from-green-900/20 dark:to-green-800/20 w-16 h-16 rounded-full flex items-center justify-center">
                    ...
                    <div class="space-y-4">
                        ...
                        @if($appointment->special_instructions)
                            <div class="border-l-4 border-indigo-400 pl-4">
                                ...
                                <p class="text-gray-700 dark:text-gray-300">{{ $appointment->special_instructions }}</p>
                            </div>
                        @endif
                    </div>
                </div>
                        ...
                        <div class="space-y-6">
                            ...
                            @if($appointment->follow_up_instructions)
                                <div class="bg-yellow-50 dark:bg-yellow-900/20 p-4 rounded-lg border border-yellow-200 dark:border-yellow-700">
                                    ...
                                    <p class="text-yellow-800 dark:text-yellow-300">{{ $appointment->follow_up_instructions }}</p>
                                </div>
                            @endif
                        </div>
                    </div>
                        ...
                        <ul role="list" class="-mb-8">
                            ...
                            <li>
                                <div class="relative pb-8">
                                    ...
                                    <div class="relative flex space-x-3">
                                        <div class="bg-blue-500 h-8 w-8 rounded-full flex items-center justify-center ring-8 ring-white dark:ring-gray-800">
                            ...
                            @if($appointment->cancelled_at)
                                <li>
                                    <div class="relative">
                                        <div class="relative flex space-x-3">
                                            <div class="bg-red-500 h-8 w-8 rounded-full flex items-center justify-center ring-8 ring-white dark:ring-gray-800">
                                                <i class="fas fa-times text-white text-xs"></i>
                                            </div>
                                            <div class="min-w-0 flex-1 pt-1.5 flex justify-between space-x-4">
                                                <div>
                                                    <p class="text-sm text-gray-900 dark:text-white font-medium">Appointment Cancelled</p>
                                                    <p class="text-xs text-gray-500 dark:text-gray-400">by {{ $appointment->cancelled_by }}</p>
                            ...
                            @if($appointment->rescheduled_at)
                                <li>
                                    <div class="relative pb-8">
                                        <span class="absolute top-4 left-4 -ml-px h-full w-0.5 bg-gray-200 dark:bg-gray-600" aria-hidden="true"></span>
                                        <div class="relative flex space-x-3">
                                            <div class="bg-yellow-500 h-8 w-8 rounded-full flex items-center justify-center ring-8 ring-white dark:ring-gray-800">
                                                <i class="fas fa-calendar-alt text-white text-xs"></i>
                                            </div>
                                            <div class="min-w-0 flex-1 pt-1.5 flex justify-between space-x-4">
                                                <div>
                                                    <p class="text-sm text-gray-900 dark:text-white font-medium">Appointment Rescheduled</p>
                                                    <p class="text-xs text-gray-500 dark:text-gray-400">by {{ $appointment->rescheduled_by }}</p>
...
<div id="ratingModal" class="fixed inset-0 bg-gray-600 bg-opacity-50 hidden overflow-y-auto h-full w-full z-50">
    <div class="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-lg bg-white dark:bg-gray-800">
        <div class="mt-3">
            ...
            <form action="{{ route('patient.appointments.rate', $appointment) }}" method="POST" id="ratingForm">
                @csrf
                <div class="px-7 py-3 space-y-4">
                    <div>
                        ...
                        <div class="rating-stars flex justify-center space-x-1">
                            @for($i = 1; $i <= 5; $i++)
                                <span class="star cursor-pointer text-2xl text-gray-300 hover:text-yellow-400 transition-colors duration-200" data-rating="{{ $i }}">
