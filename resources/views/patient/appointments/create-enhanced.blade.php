...
@section('title', 'Book New Appointment - MediCare')
        ...
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="text-center mb-8">
                ...
                <p class="text-gray-600 dark:text-gray-400">
                    Find the right doctor and schedule your appointment in just a few simple steps
                </p>
            </div>

            {{-- Progress Stepper --}}
            <x-appointment.progress-stepper :currentStep="1" />
            ...
            <form id="appointmentBookingForm" action="{{ route('patient.appointments.store') }}" method="POST">
                ...
                <input type="hidden" id="selected_service_id" name="service_id" value="">
                <input type="hidden" id="selected_date" name="appointment_date" value="">
                <input type="hidden" id="selected_time" name="start_time" value=""> {{-- Step 1: Doctor Search and Selection --}}
                ...
                <div id="step_2" class="step-content hidden">
                    <x-appointment.service-selection />
                </div>

                {{-- Step 3: Date and Time Selection --}}
                <div id="step_3" class="step-content hidden">
                    <x-appointment.datetime-selection />
                </div>

                {{-- Step 4: Confirmation --}}
                <div id="step_4" class="step-content hidden">
    ...
    <script>
        class AppointmentBooking {
            ...
            selectTimeSlot(time, button) {
                ...
                // Move to final step (confirmation)
                this.nextStep();
            }
