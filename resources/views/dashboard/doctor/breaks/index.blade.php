        ...
        <div class="mb-8">
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center space-x-3">
                    ...
                    <a href="{{ route('doctor.breaks.create') }}"
                        class="bg-orange-600 hover:bg-orange-700 text-white px-4 py-2 rounded-md text-sm font-medium transition-colors duration-200">
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow rounded-lg">
                <div class="p-5">
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                <dt class="text-sm font-medium text-gray-500 dark:text-gray-400 truncate">Recurring Breaks
                                </dt>
                                <dd class="text-lg font-medium text-gray-900 dark:text-white">
                                    {{ $breaks->where('is_recurring', true)->count() }}</dd>
                            </dl>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                ...
                                <dd class="text-lg font-medium text-gray-900 dark:text-white">
                                    {{ $breaks->where('is_active', true)->count() }}</dd>
                            </dl>
                        </div>
                    </div>
                </div>
                    ...
                    @foreach ($days as $index => $day)
                        ...
                        <div class="border border-gray-200 dark:border-gray-700 rounded-lg p-4">
                            <div class="flex items-center justify-between mb-4">
                                ...
                                <a href="{{ route('doctor.breaks.create', ['day' => $day]) }}"
                            ...
                            @if ($dayBreaks->count() > 0)
                                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                                    @foreach ($dayBreaks as $break)
                                        <div
                                            class="bg-orange-50 dark:bg-orange-900/15 rounded-lg p-4 border border-orange-200 dark:border-orange-700">
                                            <div class="flex items-center justify-between mb-2">
                                                <h5 class="font-medium text-orange-900 dark:text-orange-100">
                                                    {{ $break->title }}</h5>
                                                <div class="flex space-x-1">
                                                    <a href="{{ route('doctor.breaks.edit', $break) }}"
                                                        class="text-blue-600 hover:text-blue-800 text-sm">
                                                        <i class="fas fa-edit"></i>
                                                    </a>
                                                    <form method="POST"
                                                        action="{{ route('doctor.breaks.destroy', $break) }}"
                                                        class="inline">
                                                        @csrf
                                                        @method('DELETE')
                                                        <button type="submit"
                            ...
                            @else
                                <div class="text-center py-8 text-gray-500 dark:text-gray-400">
                                    ...
                                    <a href="{{ route('doctor.breaks.create', ['day' => $day]) }}"
                                        class="mt-2 text-orange-600 hover:text-orange-800 font-medium">
            ...
            <div class="bg-white dark:bg-gray-800 shadow rounded-lg">
                ...
                <div class="p-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                        <a href="{{ route('doctor.breaks.create', ['type' => 'lunch']) }}"
                            class="flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-orange-600 hover:bg-orange-700 transition-colors duration-200">
                            <i class="fas fa-utensils mr-2"></i>
                            Set Lunch Break
                        </a>
                        <button id="copy-to-all-days"
                        ...
                        <a href="{{ route('doctor.breaks.create', ['type' => 'personal', 'duration' => '15']) }}"
                        ...
                        <a href="{{ route('doctor.breaks.create', ['type' => 'other']) }}"
