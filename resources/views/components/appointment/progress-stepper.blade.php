...
<div class="progress-stepper w-full max-w-6xl mx-auto mb-12">
    <div class="relative">
        ...
        <div class="relative flex justify-between items-center">
            @for ($step = 1; $step <= $totalSteps; $step++)
                <div class="step flex flex-col items-center cursor-pointer group" data-step="{{ $step }}"
                    ...
                    <div class="step-label mt-3 text-center max-w-24">
                        <div
                            class="text-xs font-semibold leading-tight transition-all duration-300
    ...
    <div class="text-center mt-6">
        <div class="text-sm text-gray-500 dark:text-gray-400">
            Step <span
                class="current_step_display font-semibold text-blue-600 dark:text-blue-400">{{ $currentStep }}</span>
            of {{ $totalSteps }}
        </div>
