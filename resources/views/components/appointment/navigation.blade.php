...
<div
    class="flex flex-col sm:flex-row justify-between items-center gap-4 p-6 bg-white dark:bg-gray-800 rounded-2xl shadow-lg">
    {{-- Back Button --}}
    ...
    <div class="order-1 sm:order-2 text-center">
        <div class="text-sm text-gray-500 dark:text-gray-400">
            Step <span
                class="current_step_display font-semibold text-blue-600 dark:text-blue-400">{{ $currentStep }}</span> of
            5
        </div>
