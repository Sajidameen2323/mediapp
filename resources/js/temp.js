class AppointmentBooking {
    ...
    updateConfirmationDetails() {
        ...
        if (!this.selectedData.doctor || !this.selectedData.service || !this.selectedData.date || !this.selectedData.time) {
            return;
        }
        ...
        if (confirmSymptoms) confirmSymptoms.textContent = this.selectedData.details.symptoms || 'None specified';
        if (confirmPriority) {
    ...
    validateCurrentStep() {
        switch (this.currentStep) {
            ...
            case 4:
                ...
                this.selectedData.details.appointment_type = document.getElementById('appointment_type')?.value ||
                    'consultation';
                break;
        }
        return true;
